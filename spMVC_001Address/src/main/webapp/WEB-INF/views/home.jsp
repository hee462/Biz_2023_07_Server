...
<c:set value="20230701-011" var="version" />
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
...
<link href="${rootPath}/static/css/detail.css?v=${version}" rel="stylesheet">
<script>
	//JSP에서 사용하는 rootPath 변수를 JS코드에서 사용하기 위한 rootPath 변수로 재설정
