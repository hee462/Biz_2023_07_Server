 ...
 *  실제 호출될때는 두개가 연결 Mapping으로 사용된다
 * 
 * 
 */

/*
 * 공통으로 사용하기때문에 공통값을 먼저 줌
 */
...
public class UserController {
	...
	// localhost:8080/rootPath/user/login 으로 Request되었을때 호출되는 method
	...
	public String login(@ModelAttribute("USER") UserDto userDto, HttpSession httpSession, SessionStatus sessionStatus) {
		try {
			...
			// new Exception(message) 라고 보낸 Exception에서 message에 해당하는 부분 getter하기
